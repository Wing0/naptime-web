...
- Experiment routing is currently disabled with `ENABLE_FREE_EXPERIMENT = false` in `cloudflare/worker/src/index.js`. Do not enable it until the `/experiments/` pages are live on the deployed GitHub Pages branch and forced variants have been tested.
